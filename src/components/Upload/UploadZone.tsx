        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className={cn(
              ...
              "text-sm text-slate-700 hover:text-slate-900 dark:hover:text-slate-300 hover:border-slate-500 dark:hover:border-slate-600",
    ...
    <>
      ...
      <button
        ...
        className={cn(
          ...
          "text-sm text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-slate-600",
          "transition-all duration-200 cursor-pointer"
        )}
      >
        <Upload className="w-4 h-4" />
  ...
  return (
    <div className="flex items-center gap-3 p-3 rounded-lg bg-slate-50 dark:bg-vnote-surface border border-slate-200 dark:border-vnote-border">
      ...
      <button
        ...
        className="p-1.5 rounded-md hover:bg-slate-200 dark:hover:bg-vnote-hover text-slate-700 hover:text-slate-900 dark:hover:text-slate-300 transition-colors cursor-pointer"
      >
