...
import { Send, Paperclip, Video, ChevronDown, ChevronUp } from "lucide-react";
...
const SUGGESTED_QUESTIONS = [
  "Spring Boot是否完全取代了Spring MVC?",
  "三者在实际项目中应如何选择?",
  "AOP机制解决了哪些具体问题?",
];

export function ChatWindow({ noteTitle: _noteTitle }: ChatWindowProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-vnote-card rounded-lg border border-slate-200 dark:border-vnote-border overflow-hidden">
      {/* 头部 */}
      <div
        className="flex items-center justify-between px-4 py-2 border-b border-slate-200 dark:border-vnote-border cursor-pointer hover:bg-slate-50 dark:hover:bg-vnote-hover"
