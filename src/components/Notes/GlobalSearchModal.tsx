                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-shrink-0 w-14 h-10 rounded-md overflow-hidden bg-slate-100 dark:bg-vnote-surface">
                        {thumbnailUrl ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center">
                            <Video className="w-5 h-5 text-slate-500 dark:text-vnote-muted" />
                          </div>
                        )}
                      </div>
                      {/* 文字区域 */}
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-slate-500 dark:text-slate-500 line-clamp-1 mt-0.5">
                          {getSnippet(note)}
                        </div>
                        <div className="flex items-center gap-1 mt-1 text-[11px] text-slate-500 dark:text-slate-500">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0 mr-3">
                {selectedNote ? (
                  ...
                  <h3 className="text-sm text-slate-500 dark:text-slate-500">
                    视觉化总结预览
                  </h3>
                )}
              </div>
              <div className="flex items-center gap-1.5 flex-shrink-0">
                ...
                <button
                  onClick={onClose}
                  className="p-1.5 rounded-lg text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-vnote-hover transition-colors cursor-pointer"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
